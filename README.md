CYBERDOG LOCOMOTION
---
Locomotion control algorithm for quadrupedal robots of Xiaomi Robotics Lab, based on the [MIT Cheetah](https://github.com/mit-biomimetics/Cheetah-Software) open-source project and mainly includes 5 modules as below:
